      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20 md:mb-28">
          ...
          >
            ...
            <span className="text-blue-500 font-sans font-bold uppercase tracking-[0.4em] text-xs">Water Flow</span>
            <div className="h-px w-16 bg-blue-300/60"></div>
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl mx-auto text-slate-600 leading-relaxed"
          >
            Gentle passages that feel like a slow tide — calm, reflective, and grounding.
          </motion.p>
        </div>
