...
const Hero = () => {
  return (
    // Changed pt-20 to pt-32 (on mobile) and lg:pt-40 (on large screens) to push content below the fixed header
    <section id="home" className="relative w-full min-h-screen lg:h-screen lg:max-h-screen flex items-center justify-center px-4 sm:px-6 pt-32 lg:pt-40 py-8 lg:py-6 overflow-hidden scroll-mt-24">
