        ...
        <div className="max-w-md w-full">
          ...
          <div className="mb-4">
            ...
            <p className="text-slate-600 text-lg leading-relaxed font-light">
              I'm here to guide you through calm water rituals, energy support, and grounded healing practices.
            </p>
          </div>
          ...
          {/* CTA Button */}
          <a href="#booknow" className="group relative w-full inline-flex items-center gap-3 justify-center px-6 py-4 font-semibold text-white text-xl transition-all duration-300 bg-slate-900 rounded-full overflow-hidden hover:bg-blue-600 shadow-lg">
