    ...
    <section id="about-laura" className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Visual on left for swapped layout */}
          <motion.div 
          ...
          >
            ...
            <div className="space-y-6 text-slate-700 text-lg leading-relaxed font-light">
              ...
              <p>
                My work now blends clinical awareness with intuitive healing practices. I also offer personalized intention-based structured water rituals, inspired by the idea that focused intention and gentle ritual can support inner clarity and transformation.
              </p>
