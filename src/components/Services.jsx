...
const Services = ({ onServiceSelect }) => {
  const services = [
    {
      id: 1,
      name: "Reiki Support Session",
      description: "Gentle Reiki to help calm your mind, soothe tension, and restore balance.",
      icon: "✨",
      options: [
    ...
    {
      id: 2,
      name: "Massage & Energy Care",
      description: "A soothing body and energy treatment designed to invite ease and comfort.",
      icon: "🌿",
      price: "$80",
      duration: "90 min"
    },
    {
      id: 3,
      name: "Intentional Water Bottles",
      description: "Beautiful hydration bottles crafted for calm rituals and mindful sipping.",
      icon: "💧",
      price: "$25",
      ...
      <div className="max-w-6xl mx-auto mb-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl text-blue-900 mt-4">
            <span className="italic font-serif">Healing</span> Services
          </h2>
        </motion.div>
      </div>
